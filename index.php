  ...
  <?php get_header();?>
    <div class="container-fluid mt-7">
        <div class="row mb-6">
            <section class="col-lg-6 mb-lg-0 mb-5">
                <div class="tm-intro">
                    ...
                    <img src="<?php echo get_template_directory_uri();?>/img/biz-oriented-1.jpg" alt="Company Background Image" class="img-fluid tm-mb-3">
                </div>
            </section>
            <section class="col-lg-6">
                ...
                <div class="tm-strategy-box mb-5">
                    <img src="<?php echo get_template_directory_uri();?>/img/strategy-1.jpg" alt="Image" class="img-fluid tm-strategy-img">
                    <div>
                ...
                <div class="tm-strategy-box mb-5">
                    <img src="<?php echo get_template_directory_uri();?>/img/strategy-2.jpg" alt="Image" class="img-fluid tm-strategy-img">
                    <div>
                ...
                <div class="tm-strategy-box mb-5">
                    <img src="<?php echo get_template_directory_uri();?>/img/strategy-3.jpg" alt="Image" class="img-fluid tm-strategy-img">
                    <div>
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-4 col-md-6">
                <img src="<?php echo get_template_directory_uri();?>/img/biz-oriented-2.jpg" alt="Image" class="img-fluid">
    ...
    <div id="parallax-2" class="parallax-window parallax-window-2" data-parallax="scroll"
        data-image-src="<?php echo get_template_directory_uri();?>/img/biz-oriented-footer.jpg">
